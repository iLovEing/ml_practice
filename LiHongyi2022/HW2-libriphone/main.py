...
def preprocess_data(split, feat_dir, phone_path, concat_nframes, train_ratio=0.8, train_val_seed=19961111):
...
def train(input_dim, hidden_dim, num_epoch, learning_rate, train_loader, val_loader, device):
...
if __name__ == '__main__':
    ...
    #training
    train(input_dim, hidden_dim, num_epoch, learning_rate, train_loader, val_loader, device)
